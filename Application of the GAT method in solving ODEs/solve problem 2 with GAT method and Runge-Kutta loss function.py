...
# Runge-Kutta loss is defined as sum((y'-(k1+2*k2+2*k3+k4)/6)**2)
def loss_func(input1, input2):
    ...
    k1 = f(input1, input2)
    k2 = f(input1+0.01/2*k1[0], input2+0.01/2*k1[1])
    k3 = f(input1+0.01/2*k2[0], input2+0.01/2*k2[1])
    k4 = f(input1+0.01*k3[0], input2+0.01*k3[1])
    return sum([(derivative1[ii] - (k1[0][ii]+2*k2[0][ii]+2*k3[0][ii]+k4[0][ii])/6) ** 2 + (derivative2[ii] - (k1[1][ii]+2*k2[1][ii]+2*k3[1][ii]+k4[1][ii])/6) ** 2 for ii in range(100)]) / 100
